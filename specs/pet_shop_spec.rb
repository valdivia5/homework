...
class TestPetShop < Minitest::Test
  ...
  def setup
#@customers is an array of hashes with customer's names and their money
    @customers = [
      {
        name: "Alice",
        pets: [],
...
#@new_pet is a hash with customer's information, maybe the receipt of the purchase
    @new_pet = {
...
#pet_shop is a hash with three different keys(name, pets, and admin), name is the name of the shop, pets is an array (where there are different animals), admin is a hash with financial information.
  ...
  def test_add_or_remove_cash__add
    add_or_remove_cash(@pet_shop,11)
    cash = total_cash(@pet_shop)
    assert_equal(1011, cash)
  end
